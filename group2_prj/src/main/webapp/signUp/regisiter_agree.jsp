			...
			<section id="header">
				...
				<!-- Nav -->
					<nav id="nav">
						...
						<div id="sut-t_wrap">
						<h2 id="sub-t">
							<strong style="opacity:1;font-family: 'Noto Sans KR', sans-serif;font-weight: 700;" class="ani"></strong>
						</h2>
					</div>
					</section>
							...
							<div class="col-8 col-12-medium">
								<section>
									<header>
										<h2>
											<a href="index.html">
												<img class="footer_logo" src="http://localhost/group2_prj/admin/img/logo_white.png" alt="우신문화회관">
											</a>
										</h2>
										<div class="l">
											<address>
