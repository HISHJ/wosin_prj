...
if(rowCnt ==1){
	printMsg = rVO2.getRsrvtId() + "번 예약코드의 내역이 변경되었습니다.";
}//end if
%>
...
<!--취소팝업 끝-->
								...
								<section id="pop_bg_print">
									
								</section>
								<section id="pop_bg_vainfo">
									
								</section>
								<section id="pop_bg_receipt">
									
								</section>
								<section id="pop_bg_cancel">
