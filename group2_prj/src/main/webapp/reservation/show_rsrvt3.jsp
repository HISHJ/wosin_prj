...
// 공연코드랑, swId랑, 좌석이름, 좌석아이디??는어떻게받더라?
	...
	session.setAttribute("seletedSeats", selectedArr);
	
	// RsrvtDAO 제일밑에 메서드추가
	RsrvtInfoVO rsrvtVO = rDAO.selectRsrvtInfo(schId,selectedArr.length);
	//System.out.println(rsrvtVO.getTotalPrice());
	
	//System.out.println("네임seat으로받은값"+request.getParameter("seat"));// values로 안해서 처음거만 나옴 ㅇㅇ
	//System.out.println("네임seat으로받은값"+request.getParameterValues("seat"));
				...
				<section id="main">
					<div class="container">
						...
						<div class="col-12">
									...
									<div class="row">
										<div class="col-4 col-12-small">
											<section class="box" style="margin-bottom: 30px;">
												<a class="image featured"><img src="poster/rj.jpeg" alt="포스터" /></a>
												<header>
													...
													<ul class="divided">
														...
														<%if(selectedArr.length>0){
															for(int i=0;i<selectedArr.length;i++){%>
																<%-- <%= selectedArr[i]%> --%>
																<input type="text" value="<%= selectedArr[i]%>" style="border:none; width:25px; margin-left:25px;">번
															<%}
							...
							<a href="page4.html" class="button alt button_minBack">이전</a>
							<a href="page6.html" class="button alt button_minNext" title="클릭시 예매가 완료됩니다">예매하기</a>
