...
MiyaValidator.ERROR_MESSAGE = {
  /* for element */
  required   : "諛섎뱶�� �낅젰�섏뀛�� �섎뒗 �ы빆�낅땲��.",
  requiredstring : "諛섎뱶�� {required}(��)濡� �낅젰�섏뀛�� �섎뒗 �ы빆�낅땲��.",
  match      : "�낅젰�� �댁슜�� �쇱튂�섏� �딆뒿�덈떎.",
  invalid    : "�낅젰�� �댁슜�� �щ컮瑜댁� �딆뒿�덈떎.",
  min        : "{min} �댁긽�� 媛믪쓣 �낅젰�댁＜�몄슂.",
  max        : "{max} �댄븯�� 媛믪쓣 �낅젰�댁＜�몄슂.",
  minlength  : "�낅젰�� �댁슜�� {minlength}湲��� �댁긽�댁뼱�� �⑸땲��.",
  minbyte    : "�낅젰�� �댁슜�� 湲몄씠媛� {minbyte}Byte �댁긽�댁뼱�� �⑸땲��.",
  maxbyte    : "�낅젰�� �댁슜�� 湲몄씠媛� {maxbyte}Byte瑜� 珥덇낵�� �� �놁뒿�덈떎.",
  mincheck   : "{mincheck}媛쒖쓽 ��ぉ �댁긽�쇰줈 �좏깮�섏꽭��.",
  maxcheck   : "{maxcheck}媛쒖쓽 ��ぉ �댄븯濡� �좏깮�섏꽭��.",
  minselect  : "{minselect}媛쒖쓽 ��ぉ �댁긽�쇰줈 �좏깮�섏꽭��.",
  maxselect  : "{maxselect}媛쒖쓽 ��ぉ �댄븯濡� �좏깮�섏꽭��.",
  imageonly  : "�대�吏� �뚯씪留� 泥⑤� �� �� �덉뒿�덈떎.",
  fileonly   : "{fileonly} �뺤떇�� �뚯씪留� 泥⑤� �� �� �덉뒿�덈떎.",

  /* for group */
  requiremin : "{requiremin}媛� �댁긽�� ��ぉ�� �낅젰�섏뼱�� �⑸땲��.",
  requiremax : "{requiremax}媛� �댄븯�� ��ぉ�� �낅젰�섏뼱�� �⑸땲��.",

  /* for format */
  email      : "�대찓�� �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  hangul     : "諛섎뱶�� �쒓�濡� �낅젰�섏뀛�� �⑸땲��.",
  engonly    : "�곷Ц�쇰줈留� �낅젰�섏뀛�� �⑸땲��.",
  number     : "�レ옄濡쒕쭔 �낅젰�섏뀛�� �⑸땲��.",
  residentno : "二쇰��깅줉踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  jumin      : "二쇰��깅줉踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  foreignerno: "�멸뎅�몃벑濡앸쾲�� �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  bizno      : "�ъ뾽�먮벑濡앸쾲�� �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  phone      : "�꾪솕踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.\n��)02-232-0989",
  homephone  : "�좎꽑 �꾪솕踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.\n��)02-232-0989",
/*    handphone  : "�몃뱶�곕쾲�� �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.\n��)010-232-0989",*/
  handphone  : "�대��꾪솕踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.\n��)010-232-0989",
  isdate     : "�좎쭨 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.\n��)1980-12-30",
  zip        : "�고렪踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎.",
  jurino     : "踰뺤씤踰덊샇 �뺤떇�� �щ컮瑜댁� �딆뒿�덈떎."
};
/**
* form control types
*/
