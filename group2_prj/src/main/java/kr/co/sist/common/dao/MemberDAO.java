...
import ko.co.sist.vo.MemberVO;
import ko.co.sist.vo.QuitMemberVO;
...
//	3. 쿼리문생성객체얻기
		...
		join.append(" insert into member ")
...
//		insert성공후 SYSDATE->TO_CHAR(SYSDATE,'YYYY-MM-DD')변경하기.
