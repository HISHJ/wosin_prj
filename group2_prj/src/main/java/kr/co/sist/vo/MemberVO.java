...
public class MemberVO {
	...
	public MemberVO(String memberId, String pwd, String name, String birth, String gender, String zipcode, String addr1,
			String addr2, String email, String phone, String hPhone, String mailChk, String smsChk, String status,
			String mdate) {
		super();
	...
	public String toString() {
		return "MemberVO [memberId=" + memberId + ", pwd=" + pwd + ", name=" + name + ", birth=" + birth + ", gender="
				...
				+ ", phone=" + phone + ", hPhone=" + hPhone + ", mailChk=" + mailChk + ", smsChk=" + smsChk
